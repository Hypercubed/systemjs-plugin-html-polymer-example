...
(['src/bar-chart-element'], function(System) {



System.register("github:mbostock/d3@3.5.6/d3", [], false, function(__require, __exports, __module) {
...
System.register("github:mbostock/d3@3.5.6", ["github:mbostock/d3@3.5.6/d3"], true, function(require, exports, module) {
...
System.register("src/d3-bar-chart", ["github:mbostock/d3@3.5.6"], function($__export) {
  "use strict";
  var __moduleName = "src/d3-bar-chart";
  var d3;
  function Bars(opts) {
    opts = opts || {};
    ...
    execute: function() {
      ...
      Polymer({
        ...
        _draw: function() {
          ...
          d3.select(this.elem).datum(this.data).call(this.bars);
        },
        ready: function() {
